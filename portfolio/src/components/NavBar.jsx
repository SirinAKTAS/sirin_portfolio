...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center bg-black text-white fixed h-20 w-full px-4">
      <div>
        <h1 className="text-5xl font-signature mt-4">Sirin</h1>
      </div>
      <ul className="hidden md:flex">
        {links.map(({ id, link }) => (
          <li
            key={id}
            className="px-4 cursor-pointer font-medium text-gray-500 hover:text-white hover:scale-110 duration-200"
          >
